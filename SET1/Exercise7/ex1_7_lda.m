...
irish1_reduced = meas_reduced(iris_labels==0,:);
irish2_reduced = meas_reduced(iris_labels==1,:);
irish3_reduced = meas_reduced(iris_labels==2,:);

figure(4)
hold on
plot(irish1_reduced(:, 1), irish1_reduced(:, 2), 'bo');
plot(irish2_reduced(:, 1), irish2_reduced(:, 2), 'rs');
...
figure(5)
hold on
plot3(irish1_reduced(:, 1), irish1_reduced(:, 2), irish1_reduced(:, 3), 'bo');
plot3(irish2_reduced(:, 1), irish2_reduced(:, 2), irish2_reduced(:, 3), 'rs');
plot3(irish3_reduced(:, 1), irish3_reduced(:, 2), irish3_reduced(:, 3), 'g+');
hold off
